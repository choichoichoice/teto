...
const FAQ_LIST = [
  ...
  },
  {
    ...
    a: '네, 사용자의 개인정보를 최우선으로 생각합니다. 업로드하신 사진은 성격 유형 분석을 위한 목적으로만 사용되며, 저희 서버에서는 분석 완료 후 즉시 파기됩니다. 다만 AI 분석을 위해 OpenAI API를 이용하므로, 해당 업체 정책에 따라 최대 30일간 보관될 수 있습니다. 자세한 내용은 개인정보처리방침을 참고해주세요.',
  },
  {
  ...
  {
    q: 'Q4. 이 서비스는 무료인가요?',
    a: '네, "테토-에겐 분석기"의 모든 기능은 광고 수익을 통해 무료로 제공되고 있습니다. 별도의 유료 결제 없이 자유롭게 이용하실 수 있습니다.',
  },
];
