  ...
  return (
    <div className="container mx-auto px-6 sm:px-8 lg:px-12 py-20 max-w-3xl">
      ...
      <div className="bg-white rounded-xl border shadow-sm p-8 text-lg leading-relaxed">
        ...
        <p className="mb-4">처리 항목: 이용자가 AI 분석을 위해 직접 업로드하는 사진 정보.<br />보유 및 파기: 개발자는 이용자의 사진 정보를 서비스 목적 달성 시 지체 없이 파기합니다. 자체 서버에서는 AI 분석 완료 후 즉시 파기되나, OpenAI API 특성상 해당 업체에서는 최대 30일간 보관될 수 있습니다.</p>
        <b>제7조 (개인정보의 제3자 제공에 관한 사항)</b>
        <p className="mb-4">개발자는 AI 분석 기능의 구현을 위해 이용자의 사진 정보를 OpenAI (ChatGPT API)에 전송하며, 이 정보는 분석 목적 외에는 사용되지 않습니다. OpenAI의 정책에 따라 전송된 데이터는 최대 30일간 보관될 수 있습니다. 이 외에는 이용자의 사전 동의 없이 개인정보를 제3자에게 제공하지 않습니다.</p>
        <b>제8조 (개발자 정보 및 문의)</b>
